...
namespace AOJ.Temp.Lib
{
	public class Sieve
	{
		private List<long> primes_ = new List<long>(); 
		private long[] minFactors_;

		public List<long> Primes { get { return primes_; } }
		...
		public List<long> GetPrimeFactorList(long n)
		{
		...
		public Dictionary<long, int> GetPrimeFactorsOfLcm(long[] values)
		{
			var factors = new Dictionary<long, int>();
